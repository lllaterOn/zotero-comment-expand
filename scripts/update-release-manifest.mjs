...
export const UPDATE_URL = "https://raw.githubusercontent.com/lllaterOn/zotero-comment-expand/main/updates.json";
const RELEASE_BASE_URL = "https://github.com/lllaterOn/zotero-comment-expand/releases/download";
const PACKAGE_NAME = "zotero-comment-expand";
